...
def lambda_handler(event, context):
    ...
    # Prepare the SQL request that updates information of the specific organization.
    statement = """
    update
        organizations
    set
        ...
        parent_organization_name = {3},
        parent_organization_description = {4},
        root_organization_id = {5},
        root_organization_name = {6},
        root_organization_description = {7}
    where
        organization_id = {8}
    returning
            organization_id,
